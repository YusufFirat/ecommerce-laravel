  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
            ...
            <!--Diğer sitelerden Request atılmasını engellemek için kullanılan ve Unique Token oluşturan Güvenlik Amaçlı  -->
                @csrf
                <div class="row">
                <div class="col-lg-6">
                  <label for="name" class="form-label">Ad Soyad</label>
                  <input type="name" class="form-control" id="name" name="name" placeholder="Ad Soyad Giriniz" >
                </div>
                   <div class="col-lg-6">
                    ...
                    <div class="col-lg-6" >
                      ...
                      <input type="password" class="form-control" id="password2" name="password2" placeholder="Şifreyi Tekrar Giriniz">
                    </div>
                    <div class="row">
