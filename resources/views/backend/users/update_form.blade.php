...
<link rel= "stylesheet" href="{{asset('build/assets/app.91759510.css')}}">
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
            ...
            <!-- CSRF Diğer sitelerden Request atılmasını engellemek için kullanılan ve Unique Token oluşturuyor Güvenlik Amaçlı  -->
                @csrf
                @method("PUT")
                <div class="row">
                <div class="col-lg-6">
                  <label for="name" class="form-label">Ad Soyad</label>
                  <input type="name" class="form-control" id="name" name="name" placeholder="Ad Soyad Giriniz" value="{{$user->name}}">
                </div>
                   <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                      ...
                      <input type="password" class="form-control" id="password" name="password" placeholder="Şifre Giriniz" value="{{$user->password}}">
                   </div>
                    ...
                    <div class="col-lg-6 mt-2 ">
                        <div class="form-check">
                          ...
                          <label class="is_admin" for="is_admin">
                           Yetkili Kullanıcı
                          </label>
                        </div>
                        </div>
...
<script type="text/javascript" src="{{asset('build/assets/app.8cd8d675.js')}}"></script>
  </body>
</html>
